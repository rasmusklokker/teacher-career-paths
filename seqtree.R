...
seqt <- seqtree(mvad.seq~ male + Grammar + funemp + gcse5eq + fmpr + livboth,
                data=mvad, R=10000, pval=0.01, seqdist.arg=list(method="HAM", norm="auto"))
print(seqt)
...
## Not run: 
seqtreedisplay(seqt, type="d", border=NA, gvpath="C:\\Users\\B059064\\Documents\\Graphviz-10.0.1-win64")
seqtreedisplay(seqt, type="I", sortv=cmdscale(mvad.dhd, k=1), gvpath="C:\\Users\\B059064\\Documents\\Graphviz-10.0.1-win64")
